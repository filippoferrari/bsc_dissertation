...
\begin{figure}[ht]
\centering
\subcaptionbox{SpiNNaker board with 4 chips.\\
\begin{footnotesize} Source: \url{http://apt.cs.manchester.ac.uk/projects/SpiNNaker/hardware/index3.php}\end{footnotesize} \label{fig:spinnaker_board}}
  [0.45\textwidth]{\includegraphics[width=0.45\textwidth]{images/context/spinnaker_board.png}}
\subcaptionbox{SpiNNaker chip.\\ \begin{footnotesize} Source: \url{http://apt.cs.manchester.ac.uk/projects/SpiNNaker/SpiNNchip}\end{footnotesize} \label{fig:spinnaker_chip}}
